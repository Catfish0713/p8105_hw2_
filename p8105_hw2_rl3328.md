...
```
    ...
    ##  $ id   : chr [1:2435] "1" "1" "1" "1" ...
    ##  $ time : chr [1:2435] "abeta_40_42_bsl" "abeta_40_42_2" "abeta_40_42_4" "abeta_40_42_6" ...
    ##  $ value: chr [1:2435] "0.1105487" NA "0.109325197" "0.104756131" ...
...
```
    ...
    ##       id                time              value          
    ##  Length:2435        Length:2435        Length:2435       
...
- there’s 2355 participants have both `baseline` and `amyloid` data;
  -1876 participants only appear in `baseline` data; 80 participants
  only appear in `amyloid` data.
- `merge` dataset has 2355 observations and 8 variables and gave us 2355
